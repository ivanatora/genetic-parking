window.Car = function(genes){
    ...
    front_shape.position.x = this.pos.x - axis_h/2 * cos(this.heading_radians);
    front_shape.position.y = this.pos.y - axis_h/2 * sin(this.heading_radians);
    front_shape.rotate(degrees(this.heading_radians));
    ...
    back_shape.position.x = this.pos.x + axis_h/2 * cos(this.heading_radians);
    back_shape.position.y = this.pos.y + axis_h/2 * sin(this.heading_radians);
    back_shape.rotate(degrees(this.heading_radians));
...
//        this.last_heading = this.heading;
        car_shape.rotate(degrees(-this.heading_radians));
        ...
        front_shape.position.x = car_shape.position.x - axis_h/2 * cos(this.heading_radians);
        front_shape.position.y = car_shape.position.y - axis_h/2 * sin(this.heading_radians);
        front_shape.rotate(degrees(this.heading_radians));
        back_shape.position.x = car_shape.position.x + axis_h/2 * cos(this.heading_radians);
        back_shape.position.y = car_shape.position.y + axis_h/2 * sin(this.heading_radians);
        back_shape.rotate(degrees(this.heading_radians));
